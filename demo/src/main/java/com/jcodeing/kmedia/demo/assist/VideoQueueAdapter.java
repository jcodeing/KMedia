...
import com.jcodeing.kmedia.demo.assist.VideoQueueAdapter.LocalViewHolder;
import com.jcodeing.kmedia.demo.R;

public class VideoQueueAdapter extends MediaQueueRecyclerAdapter<LocalViewHolder> {
  ...
  public VideoQueueAdapter(Context context, boolean isLand) {
    inflater = LayoutInflater.from(context);
    this.isLand = isLand;
  }
  ...
  public LocalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new LocalViewHolder(
        inflater.inflate(isLand ? R.layout.item_video_queue_land : R.layout.item_video_queue_port,
            parent, false));
  }
